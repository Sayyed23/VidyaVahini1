...
const MainIndex = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground">
      {/* Navigation */}
      <header className="sticky top-0 z-10 w-full py-3 px-4 md:py-4 md:px-8 lg:px-12 flex items-center justify-between border-b border-border bg-background">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-12 flex flex-col items-center text-center">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/auth">
                <Button className="bg-primary hover:bg-primary/90 px-6 md:px-8 py-4 md:py-6 text-base md:text-lg">
                  Start Learning
                </Button>
              </Link>
            </div>
            ...
            {impactStats.map(stat => (
              <Card key={stat.id} className="bg-background hover:shadow-lg transition-shadow">
                <CardContent className="p-4 md:p-6 flex flex-col items-center text-center">
                  ...
                  <h3 className="text-2xl md:text-4xl font-bold mb-2">{stat.value}</h3>
      ...
      <section className="w-full py-12 md:py-16">
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-12">
          <div className="text-center mb-8 md:mb-12">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">Why VidyaVahini?</h2>
            <p className="text-sm md:text-base text-muted-foreground max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {/* Feature Cards */}
            <div className="p-4 md:p-6 border rounded-lg hover:border-primary/50 transition-colors">
              <div className="mb-4 text-primary">
                <svg className="w-10 h-10 md:w-12 md:h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                </svg>
              </div>
              <h3 className="text-lg md:text-xl font-semibold mb-2">Offline Accessibility</h3>
              <p className="text-sm md:text-base text-muted-foreground">Learn without internet - download courses and access them anytime</p>
            </div>
            <div className="p-4 md:p-6 border rounded-lg hover:border-primary/50 transition-colors">
              <div className="mb-4 text-primary">
                <svg className="w-10 h-10 md:w-12 md:h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="text-lg md:text-xl font-semibold mb-2">Localized Curriculum</h3>
              <p className="text-sm md:text-base text-muted-foreground">Content available in regional languages and cultural context</p>
            </div>
            <div className="p-4 md:p-6 border rounded-lg hover:border-primary/50 transition-colors">
              <div className="mb-4 text-primary">
                <svg className="w-10 h-10 md:w-12 md:h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="text-lg md:text-xl font-semibold mb-2">Community Focused</h3>
              <p className="text-sm md:text-base text-muted-foreground">Collaborative learning and local skill development programs</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* CTA section */}
      <section className="w-full py-16 md:py-20 bg-primary/90">
        <div className="max-w-4xl mx-auto px-4 md:px-6 lg:px-12 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/auth?mode=signup">
              <Button className="bg-white text-primary hover:bg-white/90 px-6 md:px-8 py-4 md:py-6 text-base md:text-lg">
                Get Started
              </Button>
            </Link>
          </div>
